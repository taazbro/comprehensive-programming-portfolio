...
def main():
    ...
    if mode == 'encrypt':
        message = 'A cipher is secure only if everything but the key can be revealed while still keeping the message a secret. You cannot rely on a cryptanalyst not having access to the same encryption software or not knowing which cipher you used. Always assume that the enemy knows the system! '
        ...
        message = '18_169_1641722501939953595346340951555728749023034476716636983781345018983'
